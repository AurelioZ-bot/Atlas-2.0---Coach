            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" value={profile.phone} onChange={handleChange} required placeholder="Ej: 11 1234 5678" className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-cyan-500 focus:border-cyan-500"/>
                </div>
              </div>
